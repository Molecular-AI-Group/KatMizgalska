...
#3. Support vector machine model with default settings
...
plt.title("Support Vector Machine ROC-AUC", fontsize=24)
...
# Step 3: Calculate average feature importance
...
plt.ylabel('Permutation Importance average over 10 iterations', fontsize=20)
plt.xlabel('Feature', fontsize=20)
plt.title('Top 15 Feature Importance in Support Vector Machine', fontsize=24)
